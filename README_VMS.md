...
>The Bathurst Mining Camp (BMC) of northern New Brunswick, Canada, is one of the most geoscientifically documented volcanogenic massive sulphide (VMS) districts globally, hosting more than 45 known Zn-Pb-Cu-Ag deposits and representing a cornerstone of Canada's historic base metal production (Goodfellow and McCutcheon, 2003). Several commodities associated with BMC VHMS deposits — including zinc, copper, indium, bismuth, tin, and antimony — appear on Canada's 2024 Critical Minerals List, positioning the camp as a strategically significant target for renewed exploration under the Canadian Critical Minerals Strategy (NRCan, 2024). Despite this legacy, recent exploration has yielded limited new discoveries, and an estimated 70% of the camp's prospective ground remains untested (McCutcheon and Walker, 2020). This disconnect between data density and exploration success motivates a reassessment of how available geoscientific datasets are being leveraged at camp scale. Machine learning (ML)-based mineral prospectivity mapping (MPM) has emerged as a powerful framework for integrating multi-source datasets to delineate high-priority exploration targets (e.g., Rodriguez-Galiano et al., 2015; Carranza and Laborte, 2015b; Zuo et al., 2023). Within the BMC, Parsa et al. (2023) demonstrated the viability of ML-based MPM for VHMS deposits along the northeastern Brunswick belt, employing an ensemble regularization approach to address class imbalance and overfitting inherent to deposit-scale training data. That study drew on the EXTECH II geoscientific database, incorporating airborne magnetic, radiometric, and electromagnetic surveys alongside Pb, Zn, and Cu in till geochemistry. However, the EXTECH II datasets are spatially confined to the northeastern belt, and the till geochemistry inputs were limited to three pathfinder elements from that subregional survey. No ML prospectivity study has yet integrated the full camp-scale NRCan airborne geophysical compilation — spanning magnetics, radiometrics, and full-tensor gravity gradiometry, as compiled by Ugalde et al. (2019) — with the complete NB till geochemistry dataset, which extends across the entire BMC and captures a broader suite of glacially dispersed pathfinder element signatures, including critical minerals-bearing indicators such as indium, bismuth, tin, and antimony. Furthermore, Parsa et al. (2023) noted that electromagnetic data yielded unreliable predictors due to masking by conductive Carboniferous overburden; accordingly, electromagnetic inputs were excluded from the present study. To date, no peer-reviewed, open-science ML prospectivity study has operated at full camp scale with this combination of inputs. This study addresses that gap by presenting the first camp-scale, open-science ML prospectivity model for the BMC, jointly leveraging the NRCan airborne geophysical compilation and the full NB till geochemistry dataset — including pathfinder elements designated as critical minerals under Canada's 2024 Critical Minerals List — with the aim of producing reproducible, publicly available targeting outputs that support both base metal exploration and critical minerals supply objectives for the broader geoscience and exploration community.
...
2. Natural Resources Canada (NRCan), 2024. Critical Minerals List. Government of Canada. https://www.canada.ca/en/campaign/critical-minerals-in-canada/critical-minerals-an-opportunity-for-canada.html
3. McCutcheon, S.R., and Walker, J.A., 2020. Great Mining Camps of Canada 8. The Bathurst Mining Camp, New Brunswick, Part 2. Geoscience Canada, 47, 143–166.
4. Rodriguez-Galiano, V., Sanchez-Castillo, M., Chica-Olmo, M., and Chica-Rivas, M., 2015. Machine learning predictive models for mineral prospectivity. Ore Geology Reviews, 71, 804–818.
5. Carranza, E.J.M., and Laborte, A.G., 2015b. Random forest predictive modeling of mineral prospectivity with small number of prospects and data with missing values in Abra (Philippines). Computers & Geosciences, 74, 60–70.
6. Zuo, R., Xiong, Y., Wang, Z., Wang, J., and Kreuzer, O.P., 2023. A new generation of artificial intelligence algorithms for mineral prospectivity mapping. Natural Resources Research, 32(5), 1859–1869.
7. Parsa, M., Lentz, D.R., and Walker, J.A., 2023. Predictive modeling of prospectivity for VHMS mineral deposits, northeastern Bathurst Mining Camp, NB, Canada, using an ensemble regularization technique. Natural Resources Research, 32, 19–36. https://doi.org/10.1007/s11053-022-10133-9
8. Ugalde, H., Morris, W.A., and van Staal, C., 2019. The Bathurst Mining Camp, New Brunswick: data integration, geophysical modelling, and implications for exploration. Canadian Journal of Earth Sciences, 56(5), 433–451. https://doi.org/10.1139/cjes-2018-0048 ✨
